<div class="recent-cases">
	...
	<ul class="cases">
		<li>
			...
			<a href="#">Learn more about: <span>Misrepresentation Claims <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span></a>
		</li>
		<li>
			<div class="copy">
			...
			<a href="#">Learn more about: <span>Unauthorized Trading Claims <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span></a>
		</li>
		<li>
			<div class="copy">
			...
			<a href="#">Learn more about: <span>Breach of Fiduciary Duty Claims <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span></a>
		</li>
	</ul>
</div>