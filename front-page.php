<div id="main-hero" class="story-block dark bg-overlay-wall-st">
	<div class="cols-2 hero-cols align-center">
		<div class="summary hero">
			...
			<h4 style="font-weight: bold;">Stock Fraud Arbitration Process:</h4>
			...
			<a class="btn btn-fw btn-outline btn-arrow" href="/loss-recovery-process"><span>Explore our full 10-step process</span></a>
			<p>
		</div>
